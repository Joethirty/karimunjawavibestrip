...
<footer class="site-footer">
        ...
        <div class="footer-column">
            ...
            <ul class="footer-links">
                ...
                if (isset($daftar_penginapan) && is_array($daftar_penginapan)):
                    foreach (array_slice($daftar_penginapan, 0, 3) as $p_item):
                        ?>
                        <li><a
                                href="<?php echo $base_url; ?>detail-page/<?php echo $p_item['id']; ?>.php"><?php echo $p_item['nama']; ?></a>
                        </li>
                    <?php
                    endforeach;
                endif;
    ...
    <div class="footer-bottom">
        <div class="container footer-bottom-inner">
            <p style="text-align: center; width: 100%; margin: 0;">&copy; <?php echo date('Y'); ?> Karimunjawa Homestay & Resort. Seluruh Hak Cipta Dilindungi.</p>
        </div>
    </div>
</footer>
...
<div id="lightbox_modal"
    style="display: none; position: fixed; z-index: 2000; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.8); justify-content: center; align-items: center; flex-direction: column;"
    onclick="tutupModalLightbox()">
    <span
        style="position: absolute; top: 20px; right: 30px; color: white; font-size: 40px; font-weight: bold; cursor: pointer;">&times;</span>
    <img id="img_modal_target" src="" alt=""
        style="max-width: 85%; max-height: 80%; object-fit: contain; border: 3px solid white;">
...
<script>
    ...
    // Fitur 5: Penanda menu Navigasi Aktif secara dinamis saat di-scroll (Hanya berjalan di Beranda)
